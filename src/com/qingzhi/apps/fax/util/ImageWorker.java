...
public abstract class ImageWorker {
     ...
     * {@link com.qingzhi.apps.fax.util.ImageWorker#processBitmap(Object)} to define the processing
     * logic). A memory and disk cache will be used if an {@link ImageCache} has
     * been set using {@link com.qingzhi.apps.fax.util.ImageWorker#addImageCache}. If the
    ...
    /**
     * Load an image specified by the data parameter into an ImageView (override
     * {@link com.qingzhi.apps.fax.util.ImageWorker#processBitmap(Object)} to define the processing logic). A memory and disk
     * cache will be used if an {@link ImageCache} has been set using
     * {@link com.qingzhi.apps.fax.util.ImageWorker#addImageCache}. If the image is found in the memory cache, it
     ...
     * to call this directly, instead use {@link com.qingzhi.apps.fax.util.ImageWorker#addImageCache} which will create and
     ...
     *            {@link com.qingzhi.apps.fax.util.ImageWorker#loadImage(Object, android.widget.ImageView)}
