...
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account,
        ...
        final String password = am.getUserData(account,"pass_md5");
        final String mUsername = am.getUserData(account,"bpn");
        if (password != null) {
            ...
            final String authToken = NetworkUtilities.authenticate(mUsername, check_md5, deviceId);
